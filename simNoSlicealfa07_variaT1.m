...
%PARAMETERS FOR THE NO SLICING CASE:
BS(1).alfa_th=0.7;   %In this way,the GBR traffic can only use up to 70% of RBs (comparable to the case with slicing at AC)
...
name_output_file=['simNoSlicingalfa07_50_20_T1_',num2str(loop_variable),'_T2_2.mat'];
